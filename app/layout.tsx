  ...
  return (
    <html lang="en">
      <body className={`${serif.variable} ${sans.variable} min-h-screen font-sans antialiased`}>
        <div className="min-h-screen border-x border-line/70 bg-paper">
          <header className="mx-auto flex w-full max-w-6xl flex-col gap-5 px-5 py-6 sm:flex-row sm:items-center sm:justify-between sm:px-8 lg:px-10">
